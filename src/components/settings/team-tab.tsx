          ...
          <DialogContent>
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                <Label htmlFor="invite-email-tab">Email</Label>
                <Input
                  id="invite-email-tab"
                  type="email"
              ...
              <div className="space-y-2">
                <Label htmlFor="invite-role-tab">Rôle</Label>
                <Select value={inviteRole} onValueChange={(v) => v && setInviteRole(v)}>
                  <SelectTrigger id="invite-role-tab">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="rounded-lg bg-muted/50 p-3 text-sm text-muted-foreground">
                <div className="flex items-center gap-2">
                  ...
                  <span>{members?.length ?? 0} / 5 membres (plan Équipe)</span>
                </div>
              </div>
            </div>
